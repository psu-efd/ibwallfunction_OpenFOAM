...
#include "immersedBoundaryNutkRoughWallFunctionFvPatchScalarField.H"
...
tmp<scalarField> immersedBoundaryNutkRoughWallFunctionFvPatchScalarField::calcNut() const
{
...
immersedBoundaryNutkRoughWallFunctionFvPatchScalarField::immersedBoundaryNutkRoughWallFunctionFvPatchScalarField
(
    const fvPatch& p,
...
immersedBoundaryNutkRoughWallFunctionFvPatchScalarField::immersedBoundaryNutkRoughWallFunctionFvPatchScalarField
(
    const immersedBoundaryNutkRoughWallFunctionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
immersedBoundaryNutkRoughWallFunctionFvPatchScalarField::immersedBoundaryNutkRoughWallFunctionFvPatchScalarField
(
    const immersedBoundaryNutkRoughWallFunctionFvPatchScalarField& wfpsf
)
:
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
scalar immersedBoundaryNutkRoughWallFunctionFvPatchScalarField::yPlusLam
(
    const scalar kappa,
    const scalar E
)
...
void immersedBoundaryNutkRoughWallFunctionFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void immersedBoundaryNutkRoughWallFunctionFvPatchScalarField::evaluate
(
...
void immersedBoundaryNutkRoughWallFunctionFvPatchScalarField::write(Ostream& os) const
{
...
/*
tmp<scalarField> immersedBoundaryNutkRoughWallFunctionFvPatchScalarField::yPlus() const
{
    const label patchi = patch().index();
...
(
    fvPatchScalarField,
    immersedBoundaryNutkRoughWallFunctionFvPatchScalarField
);
