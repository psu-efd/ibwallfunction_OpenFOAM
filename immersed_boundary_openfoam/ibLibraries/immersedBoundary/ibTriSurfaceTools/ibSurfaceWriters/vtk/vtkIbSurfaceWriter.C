...
template<class Type>
void Foam::vtkIbSurfaceWriter<Type>::writeGeometry
(
    Ostream& os,
...
namespace Foam
{
    ...
    template<>
    void Foam::vtkIbSurfaceWriter<Foam::scalar>::writeData
    (
        Ostream& os,
    ...
    template<>
    void Foam::vtkIbSurfaceWriter<Foam::vector>::writeData
    (
        Ostream& os,
    ...
    template<>
    void Foam::vtkIbSurfaceWriter<Foam::sphericalTensor>::writeData
    (
        Ostream& os,
    ...
    template<>
    void Foam::vtkIbSurfaceWriter<Foam::symmTensor>::writeData
    (
        Ostream& os,
    ...
    template<>
    void Foam::vtkIbSurfaceWriter<Foam::tensor>::writeData
    (
        Ostream& os,
...
template<class Type>
void Foam::vtkIbSurfaceWriter<Type>::writeData
(
    Ostream& os,
...
template<class Type>
Foam::vtkIbSurfaceWriter<Type>::vtkIbSurfaceWriter()
:
...
template<class Type>
void Foam::vtkIbSurfaceWriter<Type>::write
(
