...
template<class Type>
void Foam::dxIbSurfaceWriter<Type>::writeGeometry
(
    Ostream& os,
...
namespace Foam
{
    ...
    template<>
    void Foam::dxIbSurfaceWriter<Foam::scalar>::writeData
    (
        Ostream& os,
    ...
    template<>
    void Foam::dxIbSurfaceWriter<Foam::vector>::writeData
    (
        Ostream& os,
    ...
    template<>
    void Foam::dxIbSurfaceWriter<Foam::sphericalTensor>::writeData
    (
        Ostream& os,
    ...
    template<>
    void Foam::dxIbSurfaceWriter<Foam::symmTensor>::writeData
    (
        Ostream& os,
    ...
    template<>
    void Foam::dxIbSurfaceWriter<Foam::tensor>::writeData
    (
        Ostream& os,
...
// Write tensorField in DX format
template<class Type>
void Foam::dxIbSurfaceWriter<Type>::writeData
(
    Ostream& os,
...
template<class Type>
void Foam::dxIbSurfaceWriter<Type>::writeTrailer(Ostream& os)
{
...
template<class Type>
Foam::dxIbSurfaceWriter<Type>::dxIbSurfaceWriter()
:
    ibSurfaceWriter<Type>()
{}
...
template<class Type>
void Foam::dxIbSurfaceWriter<Type>::write
(
