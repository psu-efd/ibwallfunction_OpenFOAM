...
template<class Type>
void Foam::rawIbSurfaceWriter<Type>::writeGeometry
(
...
template<class Type>
void Foam::rawIbSurfaceWriter<Type>::writeData
(
...
template<class Type>
Foam::rawIbSurfaceWriter<Type>::rawIbSurfaceWriter()
:
...
template<class Type>
void Foam::rawIbSurfaceWriter<Type>::write
(
...
namespace Foam
{
    ...
    template<>
    void Foam::rawIbSurfaceWriter<bool>::write
    (
        const fileName& outputDir,
        const fileName& surfaceName,
        const pointField& points,
